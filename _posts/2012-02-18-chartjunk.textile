...
layout: main
title: Chartjunk
description: Reviewing a principle of the usability of bar charts.
...
<div class="one columns">
	...
	<div class="row clearfix">
		<div class="ten columns alpha">
			Much of my time these days is spent reading articles on usability.  One of which is particularly pertinent to my <a href="/2012/02/15/d3-basics.html">recent posts on charting</a> with D3.js.
	...
	Another fun tidbit of their findings is that the increase of a dimension is as equally detrimental as the reduction of a dimension.  So, in a bar chart, use a bar that looks like a square rather than a single line or a cube. 
		
	To summarize, anticipate that your users do not know how to read a chart and, therefore, make it very simple by leaving out unnecessary visual clutter.
